...
* [Главная страница](shop/shopping/templates/index.html).
* [Страница раздела](shop/shopping/templates/smartphones.html).
* [Страница незаполненного раздела](shop/shopping/templates/empty_section.html).
* [Страница товара](shop/shopping/templates/phone.html).
* [Страница корзины](shop/shopping/templates/cart.html).
* [Страница входа](shop/shopping/templates/login.html).
...
* Реализовать механизм анонимных отзывов как показано на макете [Страница товара](shop/shopping/templates/phone.html).
